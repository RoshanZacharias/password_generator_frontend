  ...
  return (
    <div className="wrapper">
      <div className="container wrapper-box">
        <h2>{isAuthenticated?`Welcome ${user.full_name}`:"Password Generator"}</h2>
        <div>
        ...
        {isAuthenticated ? (
          <>
            <Link to="/save-password" style={{ color: "#000000", textDecoration: "none", padding: "10px", fontSize: "15px", fontWeight: "900" }}>Save</Link>
            <Link to="/saved-passwords" style={{ color: "#000000", textDecoration: "none", padding: "10px", fontSize: "15px", fontWeight: "900" }}>Saved Passwords</Link>
            <Link to="/" onClick={handleLogout} style={{ color: "#000000", textDecoration: "none", padding: "10px", fontSize: "15px", fontWeight: "900" }}>Logout</Link>
          </>
        ) : (
          <>
